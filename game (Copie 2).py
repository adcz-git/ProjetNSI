...
fps = 60 # 30 ou 60
frequence_rappel = 1000 // fps # c'est en ms il faut parfois la convertir en s (* 0.001)
...
def deplacement_gauche() :
    ...
    for point in range (3) :
        ...
        point_x_tableau = coordonne_x_tableau
        ...
        while tableau_actuelle[coordonne_y_tableau][point_x_tableau] != 1 and point_x_tableau - 1 >= 0 :
            point_x_tableau -= 1

        if point_x_tableau == 0 and tableau_actuelle[coordonne_y_tableau][point_x_tableau] != 1 :
            lst_flag_collision.append(-1)
        else :
            lst_flag_collision.append(point_x_tableau)
    ...
    if flag_pas_de_mur :
        ...
        maximum = 0
        for valeur in lst_flag_collision :
            if valeur > maximum and valeur != -1 :
                maximum = valeur
        limite_deplacement = (maximum + 1) * 35 * zoom


    if position_joueur_x - 5*zoom*(60 // fps) >= limite_deplacement :
...
def deplacement_droite() :
    ...
    for point in range (3) :
        ...
        while tableau_actuelle[coordonne_y_tableau][point_x_tableau] != 1 and point_x_tableau + 1 <= 31 :
            point_x_tableau += 1

        if point_x_tableau == 31 and tableau_actuelle[coordonne_y_tableau][point_x_tableau] != 1 :
    ...
    if flag_pas_de_mur :
        limite_deplacement = 1120*zoom
    else :
        minimum = 99
        for valeur in lst_flag_collision :
            if minimum > valeur :
                minimum = valeur
        limite_deplacement = minimum * 35 * zoom

    if position_joueur_x + 50*zoom + 5*zoom*(60 // fps) <= limite_deplacement :
        canva_jeu.move("player", 5*zoom*(60 // fps), 0)
        position_joueur_x += 5*zoom*(60 // fps)
